...
issue](https://github.com/cisagov/samba-packer/issues) in this
...
request](https://github.com/cisagov/samba-packer/pulls), you will
...
```console
cd samba-packer
pyenv virtualenv <python_version_to_use> samba-packer
pyenv local samba-packer
