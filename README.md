...
secrets on the
[appropriate page](https://github.com/cisagov/samba-packer/settings/secrets)
...
[cool-images-ec2amicreate-samba-packer]
role_arn = arn:aws:iam::111111111111:role/EC2AMICreate-build-samba-packer
source_profile = build-samba-packer
...
AWS_PROFILE=cool-images-ec2amicreate-samba-packer packer build --timestamp-ui -var release_tag=$(./bump_version.sh show) -var is_prerelease=true src/packer.pkr.hcl
```
...
```console
AWS_PROFILE=cool-images-ec2amicreate-samba-packer packer build --timestamp-ui -var-file release.pkrvars.hcl src/packer.pkr.hcl
```
